      ...
      <?php if(is_page($login_page_id) && isset($redirect_to) && !empty($redirect_to)): ?>
        <script type="text/javascript">
           <?php if ($user->roles[0] == "subscriber"):?>
              window.location.href="https://betterboundhouse.com/author/investments/payments";
          <?php elseif($user->roles[0] == "editor"):?>
              window.location.href="https://betterboundhouse.com/author/manager";
           <?php else: ?>
