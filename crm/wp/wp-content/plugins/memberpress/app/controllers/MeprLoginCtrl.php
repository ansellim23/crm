...
class MeprLoginCtrl extends MeprBaseCtrl {
  ...
  public function process_login_form() {
    ...
    //modified Ansel;
      ...
      if ($test->roles[0] == 'subscriber'){
           header("Location: https://betterboundhouse.com/author/investments/payments");


         }
      else if ($test->roles[0] == 'editor'){
           header("Location: https://betterboundhouse.com/author/authormilestone");


         }
      else if ($test->roles[0] == 'fulfillment'){
           header("Location: https://betterboundhouse.com/author/projects");
