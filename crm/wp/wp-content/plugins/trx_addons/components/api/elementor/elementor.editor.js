...
jQuery(document).ready(function() {
	...
	$elementor_panel
		...
		.on('change', 'input[data-setting="_animation_delay"],select[data-setting="_animation"],select[data-setting="animation_duration"],select[data-setting="_animation_type"]', function( e ) {
	...
	function trx_addons_elementor_change_animation_type( fld ) {
		...
		if ( typeof preview.trx_addons_elementor_animate_items != 'undefined' ) {
			setTimeout( function() {
				preview.trx_addons_elementor_animate_items( true );
			}, 10);
