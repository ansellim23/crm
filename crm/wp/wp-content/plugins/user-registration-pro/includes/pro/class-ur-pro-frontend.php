...
class User_Registration_Pro_Frontend {
	...
	public function __construct() {
		...
		add_filter( 'user_registration_redirect_url_after_login', array( $this, 'user_registration_redirect_url_after_login' ) );
	 ...
	 * @since 3.0.0
	 */
	public function user_registration_redirect_url_after_login( $redirect_url ) {
	...
	public function user_registration_success_params( $success_params, $valid_form_data, $form_id, $user_id ) {
		...
		if ( 'yes' === get_option( 'user_registration_pro_role_based_redirection', 'no' ) ) {
			$registration_redirect = get_option( 'ur_pro_settings_redirection_after_registration' );
