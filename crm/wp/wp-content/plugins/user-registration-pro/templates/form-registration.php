...
?>
<style type="text/css">
.user-registration .uraf-profile-picture-upload{text-align: center !important;	}
.ur-frontend-form.ur-frontend-form--rounded form button[type="submit"], .ur-frontend-form.ur-frontend-form--rounded form input[type="submit"]{background: #f7b100 !important;}
.user-registration .wp_uraf_take_snapshot, .user-registration .wp_uraf_profile_picture_upload, .user-registration .uraf-profile-picture-remove{background: #f7b100 !important;}
</style>
	<div class='user-registration ur-frontend-form <?php echo esc_attr( $template_class ) . ' ' . esc_attr( $custom_class ); ?>' id='user-registration-form-<?php echo absint( $form_id ); ?>' style="width: 70%; margin: 0px auto;">
