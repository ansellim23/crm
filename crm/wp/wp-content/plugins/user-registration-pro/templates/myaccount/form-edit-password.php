		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				<p>
					...
					<input type="submit" class="user-registration-Button button" style="background: #f7b100 !important;" name="save_change_password" value="<?php esc_attr_e( 'Save changes', 'user-registration' ); ?>" />
