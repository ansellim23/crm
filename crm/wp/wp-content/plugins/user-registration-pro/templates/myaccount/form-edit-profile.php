...
<style type="text/css">
.user-registration-EditProfileForm .uraf-profile-picture-upload{text-align: center !important;	}
.ur-frontend-form.ur-frontend-form--rounded form button[type="submit"], .ur-frontend-form.ur-frontend-form--rounded form input[type="submit"], .user-registration-submit-Button{background: #f7b100 !important;}
.user-registration-EditProfileForm .wp_uraf_take_snapshot, .user-registration .wp_uraf_profile_picture_upload, .user-registration .uraf-profile-picture-remove{background: #f7b100 !important;}
/*.ur-frontend-form .user-registration-submit-Button{float: none !important; }
.ur-frontend-form .user-registration-submit-Button:hover{color:#ffffff;}*/
.field-profile_picture{display: none;}
</style>
			...
			<div class="ur-form-grid">
				<div class="user-registration-profile-fields">
					...
					<p>
						...
						?>
<!-- 						  <a  class="user-registration-submit-Button btn button" href="https://horizonsliterary.us/author/authormilestone" style="padding: 10px 15px; line-height: 1.5; display:inline-block; text-align: center; word-break: break-word; white-space: normal;   border: none; cursor: pointer;   transition: .35s all ease-out; font-size:14px; }">Back to Home</a>
 -->
					</p>
