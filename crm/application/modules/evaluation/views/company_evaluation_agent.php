...
<?foreach ($evaluations as $evaluation): ?>
  <form id="teamevaluationform" method="post">
      ...
      <div class="row">
        <div class="col-lg-11">
          <p class="text-uppercase text-success font-weight-bold display-4"><i class="fa fa-file-text-o "></i> Company evaluation</p>
      ...
      <div>
        <div class="text-right">
          <span class="p-2"><b id="total"><?=$evaluation['total_score']?></b>/<?=$evaluation['points']?><i class="fa fa-sort m-1 text-success"></i></span>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="div">
            ...
            <span style="float: right;"><b id="<?=$subtotal?>"><?=$criteria['score']?></b>/10</span>
