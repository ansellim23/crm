                  ...
                  <li><a><i class="fa fa-file-text-o"></i>  General Evaluation <span class="fa fa-chevron-down"></span></a>
                     ...
                     <ul class="nav child_menu"> 
                      ...
                      <li><a href="<?php echo site_url("coaching/SubmittedCoachingForms")?>">Coaching</a></li>
                       <li><a href="<?php echo site_url("dashboard/companyEvaluation")?>">Company Evaluation</a></li>
  ...
  <form id="teamevaluationform" method="post">
      ...
      <div>
        <div>
          ...
          <b>Evaluated by: <?echo $evaluation['firstname'] . " " . $evaluation['lastname'];?></b> <b style="float: right;">Your score: <?=$evaluation['total_score']?>/<?=$evaluation['points']?></b>
        </br> </br>
      ...
      <div>
        <div class="text-right">
          ...
          <input type="hidden" name="class_id" value="<?=$evaluation['class_id']?>">
        </div>
      </div>
              ...
              <div class="divhide hidden">
                ...
                <div class="row">
                  ...
                  if($point['criteria_id'] == $criteria['criteria_id']){
                    $c+=1;?>   
                  <div class="col">
                    <div id="<?=$c?>" class="border p-1 mb-1 text-left option col<?=$a?><?echo $point['points'] == $criteria['score']? ' colored' : ''?>" value="<?=$point['points']?>" value1="<?=$a?>">
...
<? endforeach; ?>
                ...
                <!--   <button type="button" class="btn btn-success" id="add_evaluation_score">Submit</button> -->
                  ...
                  Note: If you have any concern please <a href = "mailto: <?echo $evaluation['emailaddress']?>">contact</a> your immediate supervisor.    
                </div>
              </form>
            </div>
        </div>
