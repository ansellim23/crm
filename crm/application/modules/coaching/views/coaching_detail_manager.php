<style type="text/css">
  .signature_manager_coaching{display: none;z}
  ...
  <div class="card mb-3">
    <!-- page content -->
      <form id="coaching_sign_form" name="foo" method="post">
      ...
      <div class="container p-5 text-dark">
        ...
        <div class="row">
            <div class="col-lg-4">
              ...
              <div class="<?=($coaching_user['manager_transaction_code'] == '') ? 'signature_manager_coaching': 'done'; ?>" style="position:relative; top:0">
                ...
                <h4 class="text-uppercase  mt-5 mb-5">employee's signature</h4>
                  <?php if($coaching_user['transaction_code'] != ''):?>
               ...
               <button type="button" class="btn btn-secondary" id="sign_coaching">Update</button>
                  <?php if($coaching_user['sign_status_manager'] == 'Pending'):?>
