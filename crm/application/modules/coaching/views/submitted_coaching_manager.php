                  ...
                  if ($coaching_users > 0){
                       foreach ($coaching_users as $coaching_user){
                         ...
                         echo "<tr>";
                               ...
                               echo "<td>".$coaching_user['manager_name']."</td>";
                               echo "<td>".date('Y/m/d',strtotime($coaching_user['date_session']))."</td>"; ?>
                               <td><a class="btn btn-primary" href="<?php echo base_url('coaching/coaching_detail_manager/'.$coaching_user["coaching_id"].'');?>">View</a></td>
