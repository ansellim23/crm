      ...
      <div class="container p-5 text-dark">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div>
                    ...
                    <p class="beforeimg"><input type="date" name="session_date" id="session_date" value="<?=($coaching_user['date_session']) == NULL ? date('Y-m-d') :  $coaching_user['date_session'] ;?>"></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="beforeimg"><input type="text" name="full_name" value="<?=ucfirst($this->session->userdata['userlogin']['firstname']) .' '. ucfirst($this->session->userdata['userlogin']['lastname']);?>"></p>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <input type="text">
                <p class="beforeimg bordertop"><input type="text" value="<?=ucfirst($this->session->userdata['userlogin']['firstname']) .' '. ucfirst($this->session->userdata['userlogin']['lastname']);?>"></p>
                <button type="button" class="btn btn-success submitmargin" id="add_coaching">Submit</button>
            </div>
            <div class="col-lg-8">
