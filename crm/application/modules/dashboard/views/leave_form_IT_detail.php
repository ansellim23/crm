...
@media only screen and (max-width: 375px) {
  ...
  <div class="card mb-3">
      ...
      <table style="width:100%" cellpadding=0 cellspacing=0>
        ...
        <tr>
          ...
          <td rowspan="2" class="leave-pay">
              ...
              <?php endif;?>-->
              <input type="checkbox" name="leavepay" value="<?echo $form['requested_leave_pay'];?>" <? echo ($form['requested_leave_pay'] == 'paid' ? 'checked' :'');?> readonly>Paid<br>
              <input type="checkbox" name="leavepay" value="<?echo $form['requested_leave_pay'];?>" <? echo ($form['requested_leave_pay'] == 'unpaid' ? 'checked' :'');?> readonly>Unpaid
          </td>
        </tr>
        <tr>
        ...
        <tr class="leave-type">
          <td class="bordernone margin"><input type="checkbox" name="leavetype" value="<?echo $form['requested_leave_type'];?>" <? echo ($form['requested_leave_type'] == 'vacation' ? 'checked' :'');?> readonly>Vacation Leave</td>
          <td class="bordernone margin"><input type="checkbox" name="leavetype" value="<?echo $form['requested_leave_type'];?>" <? echo ($form['requested_leave_type'] == 'bereavement' ? 'checked' :'');?> readonly>Bereavement Leave</td>
          <td class="bordernone margin"><input type="checkbox" name="leavetype" value="<?echo $form['requested_leave_type'];?>" <? echo ($form['requested_leave_type'] == 'paternal' ? 'checked' :'');?> readonly>Paternal Leave</td>
        </tr>
        <tr class="leave-type">
          <td class="bordernone"><input type="checkbox" name="leavetype" value="<?echo $form['requested_leave_type'];?>" <? echo ($form['requested_leave_type'] == 'sick' ? 'checked' :'');?> readonly>Sick Leave</td>
          <td class="bordernone"><input type="checkbox" name="leavetype" value="<?echo $form['requested_leave_type'];?>" <? echo ($form['requested_leave_type'] == 'maternity' ? 'checked' :'');?> readonly>Maternity Leave</td>
          <td class="bordernone"><input type="checkbox" name="leavetype" value="<?echo $form['requested_leave_type'];?>" <? echo ($form['requested_leave_type'] == 'others' ? 'checked' :'');?> readonly>Others:<input type="text" name="others" class="underline"
      ...
      <div class="approval">
        <div class="divp">
            <div style="position:relative; top:0">
                <span class="d-block" style="position: relative; bottom: 30px;"><?=$form['agent_transaction_code'];?></span>
                <img style='width:100px; height:auto; position:relative; top:35;' src="<?php echo base_url('upload_signatures/'.$form['agent_signature'])?>">
           </div>
        ...
        <div class="divp">
           <?php if($form['manager_transaction_code'] != ''):?>
            <div style="position:relative; top:0">
                <span class="d-block" style="position: relative; bottom: 30px;"><?=$form['manager_transaction_code'];?></span>
                <img style='width:100px; height:auto; position:relative; top:35;' src="<?php echo base_url('upload_signatures/'.$form['manager_signature'])?>">
           </div>
        ...
        <div class="divp">
         <?php if($form['hr_signature'] != ''):?>
            <div style="position:relative; top:0">
                <span class="d-block" style="position: relative; bottom: 30px;"><?=$form['hr_transaction_code'];?></span>
                <img style='width:100px; height:auto; position:relative; top:35;' src="<?php echo base_url('upload_signatures/'.$form['hr_signature'])?>">
           </div>
      ...
      <!-- <div class="buttons">
          <button type="button" class="btn btn-success" id="add_leave">Submit</button>
