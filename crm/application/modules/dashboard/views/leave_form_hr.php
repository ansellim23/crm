      ...
      <div class="approval">
        <div class="divp">
           <div class="signature_agent_leave_form" style="position:relative; top:0">
                  <span class="d-block" style="position: relative; bottom: 30px;"><?=$transaction_code;?></span>
                  <img style='width:100px; height: auto; position:relative; top:35px; left:20px;' src="<?php echo base_url('upload_signatures/'.$user_signature['signature'])?>">
