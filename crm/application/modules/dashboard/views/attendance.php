...
<html lang="en">
  ...
  <link rel="icon" href="<?php echo base_url().'images/HORIZONS-LOGO-2.png';?>" type="image/ico" />
    ...
    <style type="text/css">
        ...
        #loader_3 {border: 12px solid #f3f3f3; border-radius: 50%; border-top: 12px solid #444444; width: 70px; height: 70px; animation: spin 1s linear infinite;}
        @keyframes spin {100% {transform: rotate(360deg);}}
        .center_3 {position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto;}

        #loader_4 {border: 12px solid #f3f3f3; border-radius: 50%; border-top: 12px solid #444444; width: 70px; height: 70px; animation: spin 1s linear infinite;}
        @keyframes spin {100% {transform: rotate(360deg);}}
        .center_4 {position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto;}
                  ...
                  if ($attendance_users > 0){
                       ...
                       foreach ($attendance_users as $attendance_user){
                        ...
                        if($attendance_user['time_in'] != NULL && $attendance_user['time_out'] == NULL && date("Y-m-d 21:45:00", strtotime($attendance_user['duty_log'])) >= date("Y-m-d H:i:s")){
                         ...
                         elseif(date('H:i:s', strtotime($attendance_user['time_out'])) < $attendance_user['time_out']  && $attendance_user['time_out'] != NULL &&  $attendance_user['time_in'] != NULL  &&  $attendance_user['approve_status'] == "Declined"){
                              $lacking_hour_points = 0.5;
                         }
                         else{
                              $lacking_hour_points = 0.0;
                               ...
                               echo "<td>".$attendance_user['attendance_id']."</td>";
                              ...
                              //  echo "<td>".substr($attendance_user['remark_attendance'], 0, 10)."</td>";
