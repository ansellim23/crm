...
$(document).ready(function(){
        var calendar = $('#calendar').fullCalendar({
           ...
           eventRender: function(event, element) {
                if(event.type == "Personal" && event.status_event == 'Reminder'){
                    element.css('background-color', '#b39318')
                }
                else if(event.type == "Personal" && event.status_event == 'Task'){
            ...
            events:"<?php echo base_url(); ?>dashboard/load_personal_calendar_agent",
            selectable:true,
            selectHelper:true,
