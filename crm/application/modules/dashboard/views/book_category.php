...
<html lang="en">
  ...
  <link rel="icon" href="<?php echo base_url().'images/HORIZONS-LOGO-2.png';?>" type="image/ico" />
    ...
    <style type="text/css">
        ...
        #addcategoryModal .modal-content{padding: 0px 20px; width: 175%; margin-left: -215px;}
                   ...
                   <li><a><i class="fa fa-history"></i> History Leads <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">    
                      ...
                      <li><a href="<?php echo site_url("dashboard/email_user_history")?>">Email Users</a></li>
                       ...
                       <li><a href="<?php echo site_url("dashboard/book_cate")?>"><i class="fa fa-file"></i> Book Categories</a>
            ...
            <i class="fa fa-table"></i>List of Report
              <div style="float:right; ">
	            <div style="display:inline-block">
	               <button style="height: 33px; position: relative;  top: 6px;" type="button" class="btn btn-primary fa fa-plus" aria-hidden="true" data-toggle="modal" data-target="#addcategoryModal" data-backdrop="static" data-keyboard="false">Add Book Category</button>
	            </div>   
		  </div>
		<!--  -->
		  </div>
                       ...
                       foreach ($author_reports as $report){
                         ...
                         echo "<tr>";
                           echo "<td>".modules::run("dashboard/setindex_prefix",$report['project_id'])."</td>"; 
                               ...
                               echo "<td><button type='button' class='btn btn-danger view_report_author' data-toggle='modal' data-target='#updatereportModal' data-backdrop='static' data-keyboard='false' data-project_id='".$report['project_id']."'>Edit</button></td>";
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                 ...
                 <div class="modal-body">
                      ...
                      <form id="addbookcategoryform" method="post">
                          <div class="alert alert-success"><p></p></div>
                        <h2>Add Book Categories Form</h2>
                        <p class="hint-text">Create Book Category.</p>
                           <div class="card-body">
                              <div class="table-responsive">
                                <button style="float:right; height:50px; width:25%;" type="button" class="btn btn-primary fa fa-plus" id="add_more_book_category">ADD MORE</button>
                               <table class="table table-bordered" id="leaddataTableFixed" width="100%" cellspacing="0">
                                  ...
                                  <tbody class="book_category_detail">
                                      <tr>
                                        <td><input class="form-control book_category" name="book_category[]" style="height:50px; width:255px;" id="book_category" type="text" placeholder="Enter a Book Category Name"></td>
                                        <td><input type="text" class="form-control book_size" name="book_size[]" style="height:50px;" id="book_size"  placeholder="Enter a  Book Size"></td>
              ...
              <div class="modal-content">
                 ...
                 <div class="modal-body">
                      ...
                      <form id="updatereportform" method="post">
                          <div class="alert alert-success"><p></p></div>
                        <h2>Edit Report</h2>
                        <p class="hint-text">Edit Report.</p>
                        ...
                        <div class="form-group">
                                <button type="button" id="update_report" class="btn btn-success btn-lg btn-block">Update</button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
                        </form>
                    </div>
