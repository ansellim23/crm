      ...
      <div class="approval">
        ...
        <div class="divp">
           <div class="<?=($form['hr_transaction_code'] == '') ? 'signature_hr_form': 'done'; ?>" style="position:relative; top:0">
                <span class="d-block" style="position: relative; bottom: 30px;"><?=($form['hr_transaction_code'] == '') ? $transaction_code : $form['hr_transaction_code'] ;?></span>
                <img style='width:100px; height:auto; position:relative; top:35;' src="<?=($form['hr_signature'] == '') ? base_url('upload_signatures/'.$user_signature['signature']) :  base_url('upload_signatures/'.$form['hr_signature']);?>">
