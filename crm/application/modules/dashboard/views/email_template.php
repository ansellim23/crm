...
<div style="border: 5px double #ada2a2; padding:10px; 10px">
    <?php echo "<p>Hi Sir/Mam,</p></br></br>". $reason. "</br><p>Kindly, Please click this link to view of my requested form: ".$link."";?>
    <div style="margin: 40px 0px 0px 0px">
    <p style="color:#6d5d5d;">Sincerely,</p>
    <h2 style="line-height:30px; color: #f73e3e; font-weight: 200;" ><?php echo $employee_name;?></h2>
    <p style="line-height:10px;"><b><?php echo $position;?></b></p>   
    </div>
