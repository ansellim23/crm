...
<html lang="en">
  <head>
    ...
    .signature_agent_undertime_form{display: none;;}
  ...
  <form id="addundertimeform" method="post">
    ...
    <div class="container-1">
      ...
      <table style="width:100%">
        ...
        <tr>
          <td>Inclusive date:<input type="date" name="inclusive-date"></td>
          <td>Duration (Time):<input type="text" name="duration"></td>
          <td>Total Number of hours:<input type="number" name="number-hours" id="number-hours" readonly> </td>
        </tr>
      </table>
      </div>
      ...
      <div class="approval">
        <div class="divp">
           <div class="signature_agent_undertime_form" style="position:relative; top:0">
                 <span class="d-block" style="position: relative; bottom: 0px;"><?=$transaction_code;?></span>
                 <img style='width:100px; height: auto; position:relative; top:0px;' src="<?php echo base_url('upload_signatures/'.$user_signature['signature'])?>">
      ...
      <div class="buttons">
          <button type="button" class="btn btn-success" id="add_undertime" disabled>Submit</button>
