...
<html lang="en">
           ...
           <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo site_url("dashboard/time_nanosleep(seconds, nanoseconds)")?>"><i class="fa clock-o"></i> Time In/Out</a> </li>
  ...
  <div class="card mb-3">
         <div class="card-header">
            <i class="fa fa-table"></i>List of User Duty Log
            <div style="float:right; "> 
                 <div style="display:inline-block">
                   <button style="height: 33px; position: relative;  top: 6px;" type="button" class="btn btn-primary fa fa-clock-o" aria-hidden="true" data-toggle="modal" data-target="#dutytimemodal" data-backdrop="static" data-keyboard="false">Duty Log</button>
               </div>   
             </div>
         </div>
          <div class="card-body">
                    ...
                    <div class="modal-content">
                      ...
                      <!-- Modal Header -->
                           <div class="modal-header">
                            <h4 class="modal-title">Time In/out</h4>
                          ...
                          <div class="modal-body">
                               <div class="alert alert-success"><p></p></div>
                                <div class="form-group">
                                  <select class="form-control duty" name="duty">
                                      ...
                                      <option value="Out">Launch In</option>
                                      <option value="Out">Launch Out</option>
                                    </select>
                               </div>
                                 <div class="col mb-3">
