        ...
        <div class="right_col" role="main">
                      ...
                      <form id="updatereportform" method="post">
                        ...
                        <span class="col-sm-12">Project Information</span></br></br>
                             ...
                             <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">Cover Designer</label>                         
                                  <select class="form-control cover_designer" name="cover_designer">
                                      <option>Please Select An Cover Designer</option>
                                      <?php 
                          ...
                          <div class="form-group col-sm-4 flex-column d-flex">
                           <?php if($report['create_user'] == 'production' || empty($report['create_user'])):?>
                            <label for="validationCustom03">Assign Author's User</label>                         
                              <select class="form-control author_id" name="author_id" >
                                <option value="">Please Select an Assign Author's User</option>
                                <?php foreach ($user_authors as $key => $author):?>
                                            <option value="<?=$author['ID'];?>"><?=ucwords($author['first_name'] .' '. $author['last_name']);?></option>
                                  <?php endforeach; ?>

                              </select>                           
                          <?php else:?>
                                <label for="validationCustom03">Author User</label>                         
                               <input class="form-control"  value="<?=ucwords($user_author_single['first_name'] .' '. $user_author_single['last_name']);?>" readonly  type="text" placeholder="Enter the Service Offered">
                               <input class="form-control " value="<?=$user_author_single['ID']?>" readonly  type="hidden">
                          <?php endif;?>
                            </div>
                           <div class="form-group col-sm-4 flex-column d-flex" style="clear:both;">
                      ...
                      <!-- Modal Header -->
                          ...
                          <form id="update_front_cover_form">
                           ...
                           <input type="hidden" readonly class="form-control" name="report_id" value="<?=$report_id;?>" placeholder="Project ID" >
                             ...
                             <input type="hidden" readonly class="form-control" name="publisher_id" placeholder="Project ID" >
                             <input type="hidden" readonly class="form-control" name="designer_id" placeholder="Project ID" >
                              <div class="modal-body">
                                <div class="card-body">
                                  <div class="table-responsive">
