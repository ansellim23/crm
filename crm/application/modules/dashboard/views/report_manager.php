 ...
 -->                </tr>
        ...
        <!-- /footer content -->
         ...
         <div class="modal fade" id="addreportModal">
                          ...
                          <div style="margin:150px 0px 0px 0px;">
                           ...
                           <div class="col-sm-2 inline-block">
                            <label for="validationCustom03">Book Categories</label>                         
                               <select class="form-control book_categories selectpicker" name="book_categories" data-live-search="true" >
           ...
           <!-- Update Report -->
         <div class="modal fade" id="updatereportModal">
            <div class="modal-dialog">
              <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                           ...
                           <div class="col-sm-2 inline-block">
                            <label for="validationCustom03">Project ID</label>                         
                             <!--   <select class="form-control project_id" name="project_id" >
                                ...
                                <input class="form-control project_id" name="project_id"  id="project_id" type="text" readonly placeholder="Enter the Project ID">
                                <input class="form-control project_id2" name="project_id2 "  id="project_id2" type="hidden" readonly placeholder="Enter the Project ID">
                            ...
                            <div class="col-sm-2 inline-block">
                              <label for="validationCustom03">Pen Name</label>                         
                               <input class="form-control pen_name" name="pen_name"  id="pen_name" type="text" placeholder="Enter the Pen Name">
                               <input class="form-control report_id" type="hidden"  name="report_id"  id="report_id" placeholder="Enter the Pen Name">
                           </div>
                          <div style="margin:150px 0px 0px 0px;">
                           <div class="col-sm-2 inline-block">
                            <label for="validationCustom03">Author's Name</label>                         
