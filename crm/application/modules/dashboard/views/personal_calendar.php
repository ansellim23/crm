  ...
  <div class="card mb-3">
      ...
      <div class="container">
                ...
                <label class="form-check-label">
                  <input type="radio" class="form-check-input type"  value="Personal" checked name="type">Personal
                </label>
             ...
             <div class="form-check inline-block personal_user">
                <input type="checkbox" class="form-check-input check_user" checked name="user_id" value="7" style="display:none;">

                <?php foreach ($all_users as $row):?>
                <div class="col-sm-4">
                  <label class="form-check-label">
                    <div class="<?php echo strtolower($row['firstname']);?>_background"></div>
                    <input type="checkbox" class="form-check-input check_user" checked name="user_id" value="<?php echo $row['user_id']; ?>"><?php echo $row['firstname'] .' '.$row['lastname'] .' - '.$row['usertype']; ?>
                  </label>
                </div>
               <?php endforeach; ?>
             </div>
...
$(document).ready(function(){
        var calendar = $('#calendar').fullCalendar({
           ...
           eventRender: function(event, element) {
                if(event.type == "Personal" && event.user_id == 1 || event.user_id == 8){
            ...
            events:"<?php echo base_url(); ?>dashboard/load_personal_calendar",
            selectable:true,
            selectHelper:true,
            ...
            var user_id = "<?=$this->session->userdata['userlogin']['user_id'];?>";
              if (event.user_id == user_id ){
                $.ajax({
                    ...
                    success:function()
                    {
                        ...
                        alert("Event Successdfully Updated");
                    }
                });
              }
              else{
                  alert("You can't update this event");
              }
            },
