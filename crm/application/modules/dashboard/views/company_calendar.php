          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-check inline-block">
               ...
               <div class="form-check inline-block">
                 <div class="company_background"></div>
                <label class="form-check-label">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
              <button type="button" id="add_company_event" class="btn btn-success">Save</button>
...
$(document).ready(function(){
        ...
        var calendar = $('#calendar').fullCalendar({
           ...
           eventRender: function(event, element) {
               if(event.type == "Company" && event.status_event == "Event"){
            ...
            events:"<?php echo base_url(); ?>dashboard/load_company_calendar",
            selectable:true,
            selectHelper:true,
            select:function(start, end, allDay)
            { 

              $("#timelinecallendarModal").modal({ show: true });
                ...
                // {
                    ...
                    $("#addcompanyform input[name='start']").val(start);
                    $("#addcompanyform input[name='end']").val(end);
            ...
            {
                var start = $.fullCalendar.formatDate(event.start, "MMMM D, YYYY h:mm A");
                var end = $.fullCalendar.formatDate(event.end, "MMMM D, YYYY h:mm A");
    ...
    function cb(start, end) {
        ...
        $("#addcompanyform input[name='start']").val(start.format('MMMM D, YYYY  h:mm A'));
        $("#addcompanyform input[name='end']").val(end.format('MMMM D, YYYY  h:mm A'));
    }
