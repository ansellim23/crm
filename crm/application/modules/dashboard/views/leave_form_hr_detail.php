...
<html lang="en">
  <head>
    ...
    .signature_hr_form{display: none;}
...
@media only screen and (max-width: 375px) {
  ...
  <div class="card mb-3">
      ...
      <table style="width:100%" cellpadding=0 cellspacing=0>
        ...
        <tr>
          ...
          <td rowspan="2" class="leave-pay">
              ...
              <?php endif;?>-->
              <input type="checkbox" name="leavepay" value="paid" <? echo ($form['requested_leave_pay'] == 'paid' ? 'checked' :'');?>>Paid<br>
              <input type="checkbox" name="leavepay" value="unpaid" <? echo ($form['requested_leave_pay'] == 'unpaid' ? 'checked' :'');?>>Unpaid
          </td>
        </tr>
        <tr>
        ...
        <tr class="leave-type">
          <td class="bordernone margin"><input type="checkbox" name="leavetype" value="vacation" <? echo ($form['requested_leave_type'] == 'vacation' ? 'checked' :'');?>>Vacation Leave</td>
          <td class="bordernone margin"><input type="checkbox" name="leavetype" value="bereavement" <? echo ($form['requested_leave_type'] == 'bereavement' ? 'checked' :'');?>>Bereavement Leave</td>
          <td class="bordernone margin"><input type="checkbox" name="leavetype" value="paternal" <? echo ($form['requested_leave_type'] == 'paternal' ? 'checked' :'');?>>Paternal Leave</td>
        </tr>
        <tr class="leave-type">
          <td class="bordernone"><input type="checkbox" name="leavetype" value="sick" <? echo ($form['requested_leave_type'] == 'sick' ? 'checked' :'');?>>Sick Leave</td>
          <td class="bordernone"><input type="checkbox" name="leavetype" value="maternity" <? echo ($form['requested_leave_type'] == 'maternity' ? 'checked' :'');?>>Maternity Leave</td>
          <td class="bordernone"><input type="checkbox" name="leavetype" value="others" <? echo ($form['requested_leave_type'] == 'others' ? 'checked' :'');?>>Others:<input type="text" name="others" class="underline"
      ...
      <div class="approval">
        ...
        <div class="divp">
           <div class="<?=($form['hr_transaction_code'] == '') ? 'signature_hr_form': 'done'; ?>" style="position:relative; top:0">
                <img style='width:150px; height:150px; position:relative; top:120px; left:60px;' src="<?=($form['hr_signature'] == '') ? base_url('upload_signatures/'.$user_signature['signature']) :  base_url('upload_signatures/'.$form['hr_signature']);?>">
                 <span class="d-block"><?=($form['hr_transaction_code'] == '') ? $transaction_code : $form['hr_transaction_code'] ;?></span>
                  <input type="hidden" name="hr_signature" value="<?=$user_signature['signature'];?>">
                  <input type="hidden" name="hr_transaction_code" value="<?=$transaction_code;?>">
       ...
       <div class="buttons">
         <?php if($form['approval_status_manager'] == 'Approved' && $form['notice_status_hr'] == 'Pending'):?>
