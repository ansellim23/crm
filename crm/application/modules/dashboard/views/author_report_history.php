...
<html lang="en">
  ...
  <link rel="icon" href="<?php echo base_url().'images/HORIZONS-LOGO-2.png';?>" type="image/ico" />
    ...
    <style type="text/css">
        ...
        #viewauthor_reportmodal .modal-content{padding: 0px 20px; width: 355%; margin-left: -615px;}
 ...
 -->                </tr>
                       ...
                       foreach ($author_reports as $report){
                         ...
                         echo "<tr>";
                           echo "<td>".modules::run("dashboard/setindex_prefix",$report['project_id'])."</td>"; 
                               echo "<td>".$report['author_name']."</td>";
                                 echo "<td><a href='#' class='view_leadhistory' data-toggle='modal' data-target='#viewleadhistorymodal' data-backdrop='static' data-keyboard='false' data-project_id=".$report['project_id']." data-userid=".$this->session->userdata['userlogin']['user_id']."</a>".$report['email_address']."</td>";
                               echo "<td>".$report['contact_number']."</td>";
                               echo "<td>".date('Y-m-d h:i:s a', strtotime($report['date_report']))."</td>";
                               echo "<td><button type='button' class='btn btn-primary view_report_author_status' data-toggle='modal' data-target='#viewauthor_reportmodal' data-backdrop='static' data-keyboard='false' data-project_id='".$report['project_id']."'>View</button></td>";
                               ...
                               echo "<td style='display:none;'>".date('Y-m-d', strtotime($report['date_report']))."</td>";
        ...
        <!-- /footer content -->
         ...
         <div class="modal fade" id="addreportModal">
                 ...
                 <div class="modal-body">
                      ...
                      <form id="addreportform" method="post">
                        ...
                        <p class="hint-text">Create Report.</p>
                          <div class="col-sm-3 inline-block">
                            <label for="validationCustom03">Author Name</label>                         
                               <select class="form-control author_name" name="author_name" >
                                <option value="">Please Select An Author</option>
                                <?php 
                                   if ($author_names > 0){
                                       foreach ($author_names as $author_name){
                                         echo "<option value='".$author_name['project_id']."'>".ucfirst($author_name['author_name'])."</option>";
                                     }
                                  } 
                                ?>
                              </select>
                            ...
                            <div class="col-sm-4 inline-block">
                              <label for="validationCustom03">Name of Editor</label>                         
                               <input class="form-control editor_name" name="editor_name"  id="editor_name" type="text" placeholder="Enter the Editor Name">
                           </div>
                           <div class="card-body">
                              <div class="table-responsive">
                                <button style="float:right; height:50px;" type="button" class="btn btn-primary fa fa-plus" id="add_more_report">ADD MORE</button>
                               <table class="table table-bordered" id="leaddataTableFixed" width="100%" cellspacing="0">
                                  ...
                                  <tbody class="author_report_detail">
                                      <tr>
                                        <td><input class="form-control activity" name="activity[]" style="height:50px; width:255px;" id="activity" type="text" placeholder="Enter the Collection Activity"></td>
                                        <td style="width:300px;">
                                         <div class="form-group mb-4" style="margin-bottom:-25px !important;">
                                                <div class="datepicker date input-group p-0 shadow-sm">
                                                    <input type="text" placeholder="Choose a Due date" name="due_date[]" class="form-control py-4 px-4 due_date">
                                                    <div class="input-group-append"><span class="input-group-text px-4"><i class="fa fa-clock-o"></i></span></div>
                                                </div>
                                            </div>
                                        </td>                    
                                        <td style="width:185px;"><input type="text" class="form-control bud_get" name="bud_get[]" style="height:50px;" id="bud_get" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  placeholder="Enter the Budget"></td>
                                        <td style="width:223px;"><input type="text" class="form-control percentage" name="percentage[]" style="height:50px;" id="percentage"  placeholder="Enter the Percentage"></td>
                                        <td><div class="progress">
                                                <div  class="progress-bar bg-success progress-bar-striped "></div>
                                             <div>
                                        </td>
                                        <td style="width:520px;"><input type="text" class="form-control remark" name="remark[]" style="height:50px;" id="remark" placeholder="Enter the Remark"></td>
                        ...
                        <div class="form-group">
                                <button type="button" id="add_report" class="btn btn-success btn-lg btn-block">Save</button>
           ...
           <!-- Update Report -->
         <div class="modal fade" id="viewauthor_reportmodal">
            <div class="modal-dialog">
              <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                 ...
                 <div class="modal-body">
                      <div class="signup-form">
                      <form id="viewreportform" method="post">
                          <div class="alert alert-success"><p></p></div>
                        <h2>View Report</h2>
                        <p class="hint-text">View Report.</p>
                            <div class="col-sm-4 inline-block" style="margin-bottom:25px;">
                              <label for="validationCustom03">Author Name</label>                         
                               <input class="form-control author_name" disabled name="author_name"  id="author_name" type="text">
                           </div>   

                            <div class="col-sm-4 inline-block" style="margin-bottom:25px;">
                              <label for="validationCustom03">Name of Editor</label>                         
                               <input class="form-control editor_name" disabled name="editor_name"  id="editor_name" type="text">
                           </div>   
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <!-- Modal Header -->
                           ...
                           <a  class="btn btn-success btn-block viewleadremark_history" style="width: 220px; margin-left:50px; color:#ffffff;" data-toggle='modal' data-target='#viewleadremarkhistorymodal' data-backdrop='static' data-keyboard='false' data-author_namn="">Lead Communications</a>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                          </div>
                          ...
                          <div class="modal-body">
                                ...
                                <form id="leadremarkform">
                                  <div class="col mb-1 w-50 p-3 align-middle" style="margin:0px auto;">
                                    ...
                                    b   <input type="hidden" readonly class="form-control" name="author_name" placeholder="Author Name" required="required">
...
var otable =  $('#leaddataTable').DataTable();
   $(function () {
