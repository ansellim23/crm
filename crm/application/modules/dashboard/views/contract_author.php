            ...
            <table class="table table-bordered" id="leaddataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th>Price</th>
                  <th>Balance</th>
                  <th>Contract Status and Approval</th>
                  <th>Date Create</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  if ($leads > 0){
                       foreach ($leads as $lead){
                         ...
                         echo "<tr>";
                               ...
                               echo "<td>".$lead['contractual_status']. '- <span class="contract_approval">'.$lead['contract_approval']."</span></td>";
                               ...
                               <div class="alert alert-success"><p></p></div>
                                 <div class="col mb-3">
                                       ...
                                       <select class="form-control contract_status" name="contract_status" style="height:50px;" >
                                          ...
                                          <option value="Endorsed">Assign Contract</option>
