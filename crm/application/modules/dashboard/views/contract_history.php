            ...
            <table class="table table-bordered" id="leaddataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th>Email Address</th>
                  <th>Contact #</th>
                  <th>Contract Status and Date Signed</th>
              ...
              <?php
                  ...
                  if ($leads > 0){
                       foreach ($leads as $lead){
                        $get_contract_date = ($lead['date_signed']) == null  ? 'Not Yet' : date("m/d/Y", strtotime($lead['date_signed']));
                         echo "<tr>";
                               ...
                               echo "<td>".$lead['lead_contractual_status']. ' - ' .$get_contract_date.  "</td>";
                               echo "<td>".$lead['alter_contractual_status']. ' - '  .date("m/d/Y", strtotime($lead['alter_contractual_date'])). "</td>";
                               echo "<td style='display:none;'>".date("Y-m-d", strtotime($lead['alter_contractual_date']))."</td>";
                          echo "</tr>";
                     }
                  }  
                  ?>
