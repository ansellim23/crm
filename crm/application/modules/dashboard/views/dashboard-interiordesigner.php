...
label {
           ...
           <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                      <li><a href="<?php echo site_url("dashboard/cover_designer")?>"><i class="fa fa-file"></i> Report </a>
                  </li>
                </ul>
             </div>
  ...
  <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-table"></i>List of Interior Designer Report
                        ...
                        foreach ($author_reports as $report){
                         ...
                         echo "<tr>";
                               ...
                               echo "<td>".$report['firstname']. ' '. $report['lastname']."</td>";
                                ...
                                else if ($this->session->userdata['userlogin']['user_id'] != $report['designer_user_id']){
                                    echo "<td>Not Yet</td>";
                               }
                               else{
                               ...
                               if ($this->session->userdata['userlogin']['user_id'] != $report['designer_user_id']){
                                    echo "<td>Not Yet</td>";
                               }
                               else{
                               ...
                               if (empty($report['status_payment'])){
                               ...
                               else if ($report['status_payment'] == "Pending"){
                                   echo "<td><button type='button' class='btn btn-primary'>Edit</button></td>";
                                   ...
                                   echo "<td><button type='button' class='btn btn-danger view_interiordesigner_report' data-toggle='modal' data-target='#update_designer_report_modal' data-backdrop='static' data-keyboard='false' data-project_id='".$report['project_id']."' data-project_status='".$report['project_status']."' data-user_id='".$report['designer_user_id']."'>Edit</button></td>";
