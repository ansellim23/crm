...
<html lang="en">
  ...
  <link rel="icon" href="<?php echo base_url().'images/HORIZONS-LOGO-2.png';?>" type="image/ico" />
    ...
    .inline-block:nth-child(3) .form-check-label{
...
.personal_background { 
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a class="nav-toggle-leads"><i class="fa fa-home"></i> All Leads Bucket <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu slideup-leads">
                ...
                <!--</ul>-->
                  ...
                  <li><a class="nav-toggle-transaction"><i class="fa fa-list"></i> Current Transactions Guide <span class="fa fa-chevron-down"></span></a>

                     <ul class="nav child_menu slideup-transaction">
                    ...
                    <li><a class="nav-toggle-production"><i class="fa fa-book"></i> Production Department <span class="fa fa-chevron-down"></span></a>

                     <ul class="nav child_menu slideup-production"> 
                ...
                <li><a class="nav-toggle-finance"><i class="fa fa-dollar"></i> Finance Department <span class="fa fa-chevron-down"></span></a>

                     <ul class="nav child_menu slideup-finance"> 
                 ...
                 <li><a class="nav-toggle-hrresource"><i class="fa fa-users"></i> Human Resource Department <span class="fa fa-chevron-down"></span></a>

                     <ul class="nav child_menu slideup-hrresource">
                 ...
                 <li><a class="nav-toggle-calendar"><i class="fa fa-calendar"></i> Calendar of Activities <span class="fa fa-chevron-down"></span></a>

                     <ul class="nav child_menu slideup-calendar"> 
  ...
  <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-table"></i>TimeLine Calendar
              <div style="float:right; ">
      </div>
  </div>
      <div class="container">
               <div class="form-check inline-block company_timeline">
                   <label class="form-check-label">
                      <input type="radio" class="form-check-input type"  checked value="Company" name="type">Company
                   </label>
                   <label class="form-check-label block">
                    <div class="reminder_background"></div>
                      <input type="checkbox" class="form-check-input status_event"  checked value="Reminder" name="status_event">Reminder
                   </label>
                   <label class="form-check-label block">
                    <div class="task_background"></div>
                      <input type="checkbox" class="form-check-input status_event"  checked value="Task" name="status_event">Task
                   </label>
                   <label class="form-check-label block">
                    <div class="event_background"></div>
                      <input type="checkbox" class="form-check-input status_event"  checked value="Event" name="status_event">Event
                   </label>
               </div>
              <div class="form-check inline-block personal_timeline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input type"  value="Personal" name="type">Personal
                </label>
                <label class="form-check-label block">
                      <input type="checkbox" class="form-check-input status_event"   value="Reminder" name="status_event">Reminder
                   </label>
                   <label class="form-check-label block">
                      <input type="checkbox" class="form-check-input status_event"  value="Task" name="status_event">Task
                   </label>
              </div>
             <div class="form-check inline-block personal_user">
                <input type="checkbox" class="form-check-input check_user" name="user_id" value="7" style="display:none;">

                <?php foreach ($all_users as $row):?>
                <div class="col-sm-4">
                  <label class="form-check-label">
                    <div class="<?php echo strtolower($row['firstname']);?>_background"></div>
                    <input type="checkbox" class="form-check-input check_user" name="user_id" value="<?php echo $row['user_id']; ?>"><?php echo $row['firstname'] .' '.$row['lastname'] .' - '.$row['usertype']; ?>
                  </label>
                </div>
               <?php endforeach; ?>
             </div>
...
<!-- Password User -->
    ...
    <!-- The Modal -->
      <div class="modal fade" id="timelinecallendarModal">
        <div class="modal-dialog">
          <div class="modal-content">
          
            <!-- Modal Header -->
            <div class="modal-header">
              <h4 class="modal-title">Time Line Calendar</h4>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
                          <form id="addtimelineform" method="post">
            ...
            <div class="modal-body">
              ...
              <div class="form-check inline-block">
                   <label class="form-check-label">
                      <input type="radio" class="form-check-input" value="Event" name="status_event">Event
                   </label>
               </div>
              <div class="form-check inline-block">
                <label class="form-check-label">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
              <button type="button" id="add_timeline" class="btn btn-success">Save</button>
...
$(document).ready(function(){
        var calendar = $('#calendar').fullCalendar({
           ...
           eventRender: function(event, element) {
                if(event.type == "TimeLine" && event.status_event == "quarterly") {
                    element.css('background-color', '#000');
                }
                else if(event.type == "Company" && event.status_event == "Event"){
                    element.css('background-color', 'green');
                }
                else if(event.type == "Company" && event.status_event == "Reminder"){
                    element.css('background-color', '#b39318');
                }
                else if(event.type == "Company" && event.status_event == "Task"){
                    element.css('background-color', '#222d48');
                }
                else if(event.type == "Personal" && event.user_id == 1 || event.user_id == 8){
                    element.css('background-color', 'rgb(94, 91, 80)');
                }
                else if(event.type == "Personal" && event.user_id == 6){
                    element.css('background-color', '#e87cd2');
                }
                else if(event.type == "Personal" && event.user_id == 11){
                    element.css('background-color', '#bf45a7');
                }
                else if(event.type == "Personal" && event.user_id == 11 || event.user_id == 13 || event.user_id == 14){
                    element.css('background-color', '#bf45a7');
                }
                else if(event.type == "Personal" && event.user_id == 2){
                    element.css('background-color', '#fbab7a');
                }
                else if(event.type == "Personal" && event.user_id == 3){
                    element.css('background-color', '#dd572e');
                }
                 else if(event.type == "Personal" && event.user_id == 10){
                    element.css('background-color', '#33fbcc');
                }
                // return  filter_type(event) && filter_status_event(event);
            },
    ...
    function cb(start, end) {
        ...
        $("#addtimelineform input[name='start']").val(start.format('MMMM D, YYYY  h:mm A'));
        $("#addtimelineform input[name='end']").val(end.format('MMMM D, YYYY  h:mm A'));
    }

    

   function filter_type(calEvent) {
      var vals = ['TimeLine'];
      var vals_status = ['TimeLine'];
      $('input:checkbox.type:checked').each(function() {
           vals.push($(this).val());

      });
      return vals.indexOf(calEvent.type) !== -1;
    }   
    ...
    $('.type').change(function() {
        ...
        if (get_type == 'Company' ){
          // $('.status_event:checked').val('Reminder');
          // $('.status_event:checked').val('Task');
          // $('.status_event:checked').val('Event');
          $('.company_timeline input[type=checkbox][value="Reminder"]').prop('checked', true);
          $('.company_timeline input[type=checkbox][value="Task"]').prop('checked', true);
          $('.company_timeline input[type=checkbox][value="Event"]').prop('checked', true);
          $('.personal_timeline input[type=checkbox][value="Reminder"]').prop('checked', false);
          $('.personal_timeline input[type=checkbox][value="Task"]').prop('checked', false);
          $('.personal_user input[type=checkbox]').prop('checked', false);

          var get_event = new Array();
            $(".company_timeline  input[name='status_event']:checked").each(function() {
          ...
          var start_source1 = {
                type:'GET',
                data: {type:get_type, status_event:get_event},
                url: base_url +'dashboard/view_status/',
           }
          ...
          $('.company_timeline input[type=checkbox][value="Reminder"]').prop('checked', false);
          $('.company_timeline input[type=checkbox][value="Task"]').prop('checked', false);
          $('.company_timeline input[type=checkbox][value="Event"]').prop('checked', false);

          $('.personal_timeline input[type=checkbox][value="Reminder"]').prop('checked', true);
          $('.personal_timeline input[type=checkbox][value="Task"]').prop('checked', true);
   ...
   // function filter_status_event(calEvent) {
   //    var vals = ['quarterly'];
   //    $('input:checkbox.status_event:checked').each(function() {
   //         vals.push($(this).val());
   ...
   //  }   
    ...
    $('.company_timeline .status_event').change(function() {
        // $("#calendar").fullCalendar("refetchEvents", filter_status_event);

         $('#calendar').fullCalendar('removeEventSources');

          var get_event = new Array();
            $("input[name='status_event']:checked").each(function() {
                get_event.push($(this).val());
            });
    
             var start_source1 = {
                type:'GET',
                data: {type:$("input[name='type']:checked").val(), status_event:get_event},
                url: base_url +'dashboard/view_status/',
           }
             $('#calendar').fullCalendar('addEventSource', start_source1);
    });
    ...
    $('.personal_timeline .status_event,  .personal_user .check_user').change(function() {
        // $("#calendar").fullCalendar("refetchEvents", filter_status_event);
         ...
         $('#calendar').fullCalendar('removeEventSources');
           ...
           var start_source1 = {
                type:'GET',
                data: {type:$("input[name='type']:checked").val(), status_event:get_event, user_id:get_user},
                url: base_url +'dashboard/view_status/'
           }
           $('#calendar').fullCalendar('addEventSource', start_source1);
    });
...
//     return $("#filter > option:selected").attr("status") === event.id;
// }
  ...
  $(".nav-toggle-calendar").click(function(){
   ...
   $(".nav-toggle-hrresource").click(function(){
    $(".slideup-leads").slideUp();
    $(".slideup-calendar").slideUp();
