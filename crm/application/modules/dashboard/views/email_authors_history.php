...
<html lang="en">
                 ...
                 <li><a><i class="fa fa-users"></i> Human Resource Department <span class="fa fa-chevron-down"></span></a>
                     ...
                     <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo site_url("account/users")?>">All Users</a></li>
                           <li><a href="<?php echo site_url("dashboard/call_log_history")?>">Team Call Logs</a></li>
                           <li><a href="<?php echo site_url("dashboard/email_user_history")?>">Email Users</a></li>
                           ...
                           <li><a href="<?php echo site_url("dashboard/email_user_history")?>">Individual Attendance Sheet</a></li>
  ...
  <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-table"></i>List of Email Users
                          ...
                          if ($email_history > 0){
                             foreach ($email_history as $email_history){
                               echo "<tr>";
                                     ...
                                     echo "<td>".date("d/m/Y h:i:s a", strtotime($email_history['date_sent']))."</td>";
                                     echo "<td style='display:none;'>".date("Y-m-d", strtotime($email_history['date_sent']))."</td>";
                                echo "</tr>";
                           }
                        }  
...
initSample();
 ...
 var otable = $('#historyemailtable').DataTable();
 $(function () {
