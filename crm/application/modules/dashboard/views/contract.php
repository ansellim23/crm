  ...
  <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="contractdataTablefixed" width="100%" cellspacing="0">
              <thead>
                <tr>
                   <th>Lead ID</th>
                  <th>Product Name</th>
                        ...
                        $approval_status = $lead['contract_approval'] == ''? 'Not Yet' : $lead['contract_approval'];
                          ...
                          echo "<tr>";
                               ...
                               echo "<td>".$lead['contractual_status']. '- <span class="date_contract_signed">'.date("Y-m-d", strtotime($lead['date_contract_signed'])) ."</span></td>";
                                ...
                                $get_count_payment = modules::run("dashboard/count_payment",$lead['project_id']);
                                if ($get_count_payment > 0){
                                     echo "<td><button type='button' style='color:#ffffff !important;'  class='btn btn-danger view_contractual_lead' data-toggle='modal' data-target='#viewlead_contractual_modal' data-backdrop='static' data-keyboard='false' data-project_id='".$lead['project_id']."'>Action</button></td>";
                                } 
                                else{
                                     echo "<td><button type='button' style='color:#ffffff !important;'  disabled class='btn btn-success'>Action</button></td>";
                                }
