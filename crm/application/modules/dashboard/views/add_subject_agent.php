  ...
  <div class="card mb-3">
         ...
         <div style="float:right; "> 
            ...
            <div style="display:inline-block">
               <button style="height: 33px; position: relative;  top: 6px;" type="button" id="add_subject" class="btn btn-success fa fa-plus">Save</button>
            </div>   
             ...
             <table class="table table-bordered" id="leaddataTableemail_author" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th>Date Create</th>
                  <th>Date Assigned</th>
                  <th><input type='checkbox' id='check_all_author' class='form-check-input' style='position:relative; width:50px;'></th>
                </tr>
              </thead>
              <tbody>
            <!--   <?php
              ...
              success: function (data) {
                  ...
                  for (var i = 0; i < data.length; i++) {
                       load_data.push({
                              ...
                              '' : "<input type='checkbox' name='project_id[]' class='form-check-input project_id' style='position:relative; width:45px;' value="+data[i].project_id+">"

                            })      
                     }
              $('#leaddataTableemail_author').removeAttr('width').DataTable( {
                        data: load_data,
                        deferRender:    true,
                        paging:false,
                        scrollY:        500,
