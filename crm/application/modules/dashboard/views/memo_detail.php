    ...
    <div class="container body">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url().'dashboard/';?>" class="site_title"><div class="image"><span>Better Bound House</span></div></a>
            </div>
        ...
        <table>
          ...
          <table>
            ...
            <tr>
              ...
              <td class="td-p-span">
                <p><span><?echo $notification['firstname']." ".$notification['lastname'];?></span></p>
              </td>
            </tr>
            <tr>
              <td class="td-p-span">
              ...
              <td class="td-p-span">
                <p><span><?echo $notification['from_user'];?></span></p>
              </td>
            </tr>
            <tr>
              <td class="td-p-span">
              ...
              <td class="td-p-span">
                <p><span><?echo date('F d, Y',strtotime($notification['date_notify']));?></span></p>
              </td>
            </tr>
            <tr>
              <td class="td-p-span">
              ...
              <td class="td-p-span">
                <p><span><?echo $notification['subject'];?></span></p>
              </td>
            </tr>
            <tr>
      ...
      <div class="form-group">
        <div class="col-auto">
          ...
          <span class="text-info"><?echo "<a href='".base_url('upload_memo/'. $notification['attached_file'])."' download>"."<i class='fa fa-download' aria-hidden='true'>".$notification['attached_file']."</i>"."</a>"?></span>
          <input type="text" name="user_id" value="<?echo $notification['to_user_id'];?>" hidden>
