...
<html lang="en">
  ...
  <link rel="icon" href="<?php echo base_url().'images/HORIZONS-LOGO-2.png';?>" type="image/ico" />
    ...
    #emailModal .modal-content{padding: 0px 20px; width: 300%; margin-left: -440px;}
    #addsignaturemodal .modal-content{padding: 0px 20px; width: 300%; margin-left: -440px;}
    #updatesignatureModal .modal-content{padding: 0px 20px; width: 300%; margin-left: -440px;}
    .Editor-container{
      background: #ffffff;
    } 
                  ...
                  <li><a href="<?php echo site_url("dashboard/time_nanosleep(seconds, nanoseconds)")?>"><i class="fa fa-clock-o"></i> Time In/Out</a> </li>
                   <li><a><i class="fa fa-history"></i> History Leads <span class="fa fa-chevron-down"></span></0>
                     <ul class="nav child_menu">    
                       ...
                       <li><a href="<?php echo site_url("dashboard/collection_activities")?>">Contract Author</a></li>
  ...
  <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-table"></i>List of Signature
              <div style="float:right; ">
            <form id="upload_lead_form" enctype="multipart/form-data"> 
              <div class="alert alert-success"><p></p></div> 
             <div style="display:inline-block">
               <button style="height: 33px; position: relative;  top: 6px;" type="button" class="btn btn-success fa fa-plus" aria-hidden="true" data-toggle="modal" data-target="#addsignaturemodal" data-backdrop="static" data-keyboard="false">ADD SIGNATUE</button>
            </div>   
<!--              <div style="display:inline-block">
                 <button style="height: 33px; position: relative;  top: 6px;" type="button" class="btn btn-warning fa fa-pencil" aria-hidden="true" data-toggle='modal' data-target='#emailModal' data-backdrop='static' data-keyboard='false'>COMPOSE</button>
              </div>      -->
            </form>
      </div>
  </div>
              ...
              <?php
                  if ($signatures > 0){
                       foreach ($signatures as $signature){
                         echo "<tr>";
                               echo "<td>".$signature['signature']."</td>";
                               echo "<td>".date("d/m/Y", strtotime($signature['date_add_description']))."</td>";
                               echo "<td><button type='button' class='btn btn-danger view_signature_detail' data-toggle='modal' data-target='#updatesignatureModal' data-backdrop='static' data-keyboard='false' data-signature_id='".$signature['signature_id']."'>Update</button></td>";                             
...
<!-- Password User -->
   ...
   <div class="modal fade" id="updatesignatureModal">
            <div class="modal-dialog">
              <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                 ...
                 <div class="modal-body">
                      <div class="signup-form">
                      <form id="updatesignatureform" method="post">
                          <div class="alert alert-success"><p></p></div>
                        <h2>Signture Form.</h2>
                        <p class="hint-text">Update Signature.</p>
                            <label for="validationCustom05">Signature Title</label>
                            <div class="form-group">
                              <input type="text" class="form-control" name="signature" placeholder="Please Enter the signature" required="required">
                            </div>
                            <label for="validationCustom05">Description</label>
                            <div class="form-group">
                                <textarea class="form-control description" id="editsignaturetxtEditor" name="description"></textarea>
                            </div>
                               <input type="hidden" class="form-control" name="signature_id" readonly required="required">
                               <input type="hidden" class="form-control" name="signature_exist" readonly required="required">
                            <div class="form-group">
                                <button type="button" id="update_signature" class="btn btn-danger btn-lg btn-block">Update</button>
                            </div>
                        </form>
                    </div>
                  </div>
 ...
 $(document).ready(function() {
    tinymce.init({
      selector: 'textarea#editsignaturetxtEditor',
      plugins: 'a11ychecker advcode casechange formatpainter linkchecker autolink lists checklist media mediaembed pageembed permanentpen powerpaste table advtable tinycomments tinymcespellchecker image imagetools nonbreaking charmap',
      toolbar: 'nonbreaking a11ycheck addcomment showcomments casechange checklist code formatpainter pageembed permanentpen table image charmap',
  ...
  */
  ...
  content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'
    ...
    tinymce.init({
      selector: 'textarea#signaturetxtEditor',
      plugins: 'nonbreaking charmap a11ychecker advcode casechange formatpainter linkchecker autolink lists checklist media mediaembed pageembed permanentpen powerpaste table advtable tinycomments tinymcespellchecker image imagetools',
      toolbar: 'nonbreaking charmap a11ycheck addcomment showcomments casechange checklist code formatpainter pageembed permanentpen table image',
      toolbar_mode: 'floating',
      tinycomments_mode: 'embedded',
      tinycomments_author: 'Author name',
      image_title: true,
