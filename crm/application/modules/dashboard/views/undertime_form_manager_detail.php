    ...
    <div class="container-1">
      ...
      <div class="approval">
        ...
        <div class="divp">
             <div class="<?=($form['manager_transaction_code'] == '') ? 'signature_manager_form': 'done'; ?>" style="position:relative; top:0">
                <img style='width:100px; height:auto; position:relative; top:35;' src="<?=($form['manager_signature'] == '') ? base_url('upload_signatures/'.$user_signature['signature']) :  base_url('upload_signatures/'.$form['manager_signature']);?>">
                 <span class="d-block" style="position: relative; bottom: 30px;"><?=($form['manager_transaction_code'] == '') ? $transaction_code : $form['manager_transaction_code'] ;?></span>
          ...
          <input type="text" name="manager_name" value=" <?=$fullname?>" readonly>
      ...
      <div class="buttons">
         <?php if($form['approval_status'] == 'Pending'):?>
          <button type="button" class="btn btn-success" id="approve_undertime" disabled>Approve</button>
          <button type="button" class="btn btn-danger" id="decline_undertime">Decline</button>
