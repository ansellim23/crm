      ...
      <div class="main_container">
          ...
          <div class="nav_menu">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1" style="height: 300px;   overflow-y: scroll;   position: absolute;   transform: translate3d(-144px, 17px, 0px);   top: 0px;   left: 0px;   will-change: transform;">
        ...
        <div class="right_col" role="main">
                      ...
                      <form id="updatesubmissionform" method="post">
                        ...
                        <p class="hint-text">Update Author Submission.</p>
                        <span class="col-sm-12">Project Information</span></br></br>
                          ...
                          <div class="form-group col-sm-4 flex-column d-flex">
                            <label for="validationCustom03">Date Sold</label>                         
                              <input class="form-control date_sold" name="date_sold"  id="date_sold" type="text" value="" placeholder="-- -- ----" readonly>
                           </div>
                           <div class="form-group col-sm-4 flex-column d-flex">
                            <label for="validationCustom03">Project Status</label>                         
                               <select class="form-control project_status" name="project_status" readonly>
                                <option>Please Select A Project Status</option>
                                <option value="<?=$report['project_status'];?>" selected><?=$report['project_status'];?></option>
                           ...
                           <span class="form-group col-sm-12">Book Design and Marketing</span></br></br>
                             <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">Interior Designer</label>                         
                                 <select class="form-control interior_designer" name="interior_designer" disabled>
                             ...
                             <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">Cover Designer</label>                         
                                  <select class="form-control cover_designer" name="cover_designer" disabled>
                                      <option value="">Please Select An Cover Designer</option>
                                      <?php 
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">Publisher/Marketing</label>                         
                                 <select class="form-control publisher_id" name="publisher_id" disabled>
                           ...
                           <div class="form-group col-sm-6 flex-column d-flex">
                            <label for="validationCustom03">Author's Name</label>                         
                              <input class="form-control author_name" disabled name="author_name"  id="author_name" type="text" value=""  placeholder="Enter the Author's Name">
                           </div>
                            <div class="form-group col-sm-6 flex-column d-flex">
                              <label for="validationCustom03">Pen Name</label>                         
                               <input class="form-control pen_name" name="pen_name"  id="pen_name" type="text" value="<?=$report['pen_name'];?>" placeholder="Enter the Pen Name" disabled>
                               <input class="form-control report_id" name="report_id"  id="report_id" type="hidden" value="<?=$report_id?>" placeholder="Enter the Report Id" readonly>
                               <input class="form-control" name="author_id"  id="author_id" type="hidden" value="<?=$report['author_id']?>" placeholder="Enter the Report Id" readonly>
                           </div>
                           ...
                           <div class="form-group col-sm-3 flex-column d-flex">
                              <label for="validationCustom03">Author's Book Count</label>                         
                               <input class="form-control number_of_book" name="number_of_book"  id="number_of_book" value="<?=$report['number_of_books'];?>" type="text" placeholder="Enter the Number of Books" disabled>
                           </div>
                           <div class="form-group col-sm-3 flex-column d-flex">
                            <label for="validationCustom03">Book Categories</label>                         
                               <select class="form-control book_categories selectpicker" name="book_categories"  id="book_categories" data-live-search="true" disabled>
                           ...
                           <div class="form-group col-sm-3 flex-column d-flex">
                            <label for="validationCustom03">Book Color Type</label>                         
                               <select class="form-control book_color" name="book_color" disabled>
                            ...
                            <label for="validationCustom03">Book Size</label>                         
                               <select class="form-control book_size" name="book_size" disabled>
                            ...
                            <label for="validationCustom03">Paper Color Type</label>                         
                               <select class="form-control color_type" name="color_type" disabled>
                           ...
                           <div class="form-group col-sm-4 flex-column d-flex">
                            <label for="validationCustom03">Hardcover Format (if applicable)</label>                         
                              <select class="form-control hard_cover_format" name="hard_cover_format" disabled>
                           ...
                           <div class="form-group col-sm-4 flex-column d-flex">
                             <label for="validationCustom03">Audience</label>                         
                               <input class="form-control audience" name="audience" value="<?=$report['audience'];?>"  id="audience" type="text" placeholder="Enter the Audience" disabled>
                           </div>
                           <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">Book Title/s & Sub Title/s</label>                         
                                <textarea class="form-control book_title" rows disab="2" name="book_title"></textarea>
                           </div>
                            <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">About the Author</label>                         
                                  <textarea class="form-control about_author" rows="2" name="about_author" disabled><?=$report['book_colortype'];?></textarea>
                           </div>
                            <div class="form-group col-sm-4 flex-column d-flex">
                              <label for="validationCustom03">About the Book</label>                         
                                  <textarea class="form-control about_book" rows="2" name="about_book" disabled><?=$report['about_book'];?></textarea>
                           </div>
                            <div class="form-group col-sm-3 flex-column d-flex">
                              <label for="validationCustom03">Cover Design Instructions</label>                         
                                <textarea class="form-control cover_design" rows="2" name="cover_design" disabled><?=$report['cover_design_ints'];?></textarea>
                            </div>
                            <div class="form-group col-sm-3 flex-column d-flex">
                              <label for="validationCustom03">Interior Design Instructions</label>                         
                                <textarea class="form-control interior_design" rows="2" name="interior_design" disabled><?=$report['interior_design_ints'];?></textarea>
                            </div>
                            <div class="form-group col-sm-3 flex-column d-flex">
                              <label for="validationCustom03">Publishing Logo Instructions</label>                         
                                  <textarea class="form-control publishing_logo" rows="2" name="publishing_logo" disabled><?=$report['publishing_logo_ints'];?></textarea>
                            </div>
                             <div class="form-group col-sm-3 flex-column d-flex">
                              <label for="validationCustom03">Mailing Address</label>                         
                                  <textarea class="form-control mailing_address"  rows="2" name="mailing_address" disabled><?=$report['mailing_address'];?></textarea>
                            </div>
                           <div class="form-group col-sm-4 flex-column d-flex">
                               <label for="validationCustom03">Publishing Name</label>                         
                               <input class="form-control publishing_name" name="publishing_name" value="<?=$report['publishing_name'];?>" id="publishing_name" type="text" placeholder="Enter the Publishing Name" disabled>
                           </div>
                            <div class="form-group col-sm-4 flex-column d-flex">
                            <label for="validationCustom03">Author's Picture</label>      
                              <select class="form-control author_picture" name="author_picture" disabled>                   
...
<!--                            <div class="form-group col-sm-4 flex-column d-flex">
                              <button type="button" class="btn btn-outline-success btn-lg line_word_details" data-toggle='modal' data-target="#sidemodal1" data-project_id="<?=$report['project_id'];?>" disabled>Lines/Words</button>
                           </div>
                           <div class="form-group col-sm-4 flex-column d-flex">
                              <button type="button" class="btn btn-outline-success btn-lg front_cover_details" data-toggle='modal' data-target="#sidemodal2" data-project_id="<?=$report['project_id'];?>" disabled>Front Cover</button>
                           </div>  
                           <div class="form-group col-sm-4 flex-column d-flex">
                              <button type="button" class="btn btn-outline-success btn-lg back_cover_details" data-toggle='modal' data-target="#sidemodal3" data-project_id="<?=$report['project_id'];?>" disabled>Back Cover</button>
                           </div>  -->
                        <div class="form-group" style="text-align: center;">
                                <button type="button" id="update_submission" class="btn btn-success btn-lg btn-block" style="width:10%;">Update</button>
