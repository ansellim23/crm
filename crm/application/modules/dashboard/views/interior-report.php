                        ...
                        foreach ($author_reports as $report){
                         ...
                         echo "<tr>";
                              ...
                              if (empty($report['lead_project_id']) || $report['interior_user_id'] != $report['designer_user_id']){
                                ...
                                echo "<td><button type='button' class='btn btn-primary view_designer_detail' data-toggle='modal' data-target='#detail_designer_report_modal' data-backdrop='static' data-keyboard='false' data-report_id='".$report['report_id']."' data-project_id='".$report['project_id']."' data-usertype='".$report['usertype']."' data-project_status='".$report['project_status']."'   data-designer_report_id='".$report['designer_report_id']."' data-user_id='".$report['interior_user_id']."'>View</button></td>";
              ...
              <div class="modal-content">
                 ...
                 <div class="modal-body">
                      ...
                      <form id="viewdetails" method="post">
                        ...
                        <h2>Interior Designer Detail</h2>
                        ...
                        <div class="card-body">
                              <div class="table-responsive">
                               <table class="table table-bordered" id="leaddataTableFixed" width="100%" cellspacing="0">
                                  <thead>
                                    <tr>
                                      <th style="width:110px;">Page Number</th>
                                      <th style="width:140px;">Paragraph Number</th>
                                      <th>Line Number</th>
