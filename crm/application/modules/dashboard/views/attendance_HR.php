...
<html lang="en">
  ...
  <link rel="icon" href="<?php echo base_url().'images/HORIZONS-LOGO-2.png';?>" type="image/ico" />
    ...
    /* preloader */
    #loader_10 {border: 12px solid #f3f3f3; border-radius: 50%; border-top: 12px solid #444444; width: 70px; height: 70px; animation: spin 1s linear infinite;}
    @keyframes spin {100% {transform: rotate(360deg);}}
    .center_10 {position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto;}
    #loader_11 {border: 12px solid #f3f3f3; border-radius: 50%; border-top: 12px solid #444444; width: 70px; height: 70px; animation: spin 1s linear infinite;}
    @keyframes spin {100% {transform: rotate(360deg);}}
    .center_11 {position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto;}
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu"> 
                ...
                <li><a href="<?php echo site_url("dashboard/SubmittedFormsHr")?>"><i class="fa fa-paper-plane"></i>Submitted Form</a></li>
                             ...
                             <form id="update_attendance_form">
                               <div class="alert alert-success"><p></p></div>
                                ...
                                <input type="hidden" class="form-control" id="duty_log" readonly name="duty_log"/>
                                  <div id="loader_11" class="center_11"></div>
                          ...
                          <div class="modal-body">
                                ...
                                <form id="attendance_remarkform">
                                  <div class="col mb-1 w-50 p-3 align-middle" style="margin:0px auto;">
                                        ...
                                        <div id="loader_10" class="center_10"></div>
