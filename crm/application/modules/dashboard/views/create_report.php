        ...
        <div class="right_col" role="main">
                      ...
                      <form id="addreportform" method="post">
                          ...
                          <div class="form-group col-sm-4 flex-column d-flex">
                           ...
                           <div class="form-group col-sm-3 flex-column d-flex">
                              <label for="validationCustom03">Author's Book Count</label>                         
                               ...
                               <input class="form-control " name="author_id"  id="author_id" type="hidden" placeholder="Enter the Number of Books" readonly>
                           </div>
                           <div class="form-group col-sm-3 flex-column d-flex">
                           ...
                           <div class="form-group col-sm-4 flex-column d-flex">
                            ...
                            <label for="validationCustom03">Assign Author's User</label>                         
                              <select class="form-control author_id" name="author_id" readonly>
                                <option value="">Please A Author's Name</option>
                            ...
                            <div class="card-body">
                              <div class="table-responsive">
                               ...
                               <table class="table table-bordered" id="leaddataTableFixed" width="100%" cellspacing="0">
                                  <thead>
                                    <tr>
                                      <th style="width:145px;">Page Number</th>
                        ...
                        <div class="form-group" style="text-align: center;">
                                <button type="button" id="add_report" class="btn btn-success btn-lg btn-block add_report" style="width:10%;" disabled>Save</button>
