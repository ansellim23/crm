                  ...
                  <?
                    if($this_week_events > 0){
                      foreach ($this_week_events as $event) {
                        ...
                        echo "<div class='row border-bottom mt-2'>";
                        echo "<div class='col-md-6 font-weight-bold'><input type='checkbox' class='update_todo_status' value='".$event['event_id']."'".$disable."> ".$event['event_title']."</div>";
                  ...
                  <?
                    if($done_early_events > 0){
                      foreach ($done_early_events as $event) {
                        $disable = $event['user_id'] != $event['to_user']? 'disabled="disabled"' : '';
                        echo "<div class='row border-bottom mt-2'>";
                        echo "<div class='col-md-6 font-weight-bold'><input type='checkbox' class='update_todo_status1' value='".$event['event_id']."'".$disable."> ".$event['event_title']."</div>";
