        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><div class="image"> <span>Better Bound House</div></a>
            </div>
            ...
            <table class="table table-bordered" id="leaddataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th>Email Address</th>
                  <th>Contact #</th>
                  <th>Approval Status and Date Approved</th>
              ...
              <tbody>
              <?php
                  $get_contract_date = null;
                  if ($leads > 0){
                       foreach ($leads as $lead){
                        $get_contract_date = ($lead['date_approved']) == null  ? 'Not Yet' : date("m/d/Y", strtotime($lead['date_approved']));
                         echo "<tr>";
                               ...
                               echo "<td>".$lead['author_contract_status']. ' - ' .$get_contract_date.  "</td>";
                               echo "<td>".$lead['alter_contract_approved']. ' - '  .date("m/d/Y", strtotime($lead['alter_contract_date_approved'])). "</td>";
                               echo "<td style='display:none;'>".date("Y-m-d", strtotime($lead['alter_contract_date_approved']))."</td>";
                          echo "</tr>";
                     }
                  }  
                  ?>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <!-- Modal Header -->
                           <div class="modal-header">
                            <h4 class="modal-title">Your Lead History </h4> 
                           <a  class="btn btn-success btn-block viewleadremark_history" style="width: 220px; margin-left:50px; color:#ffffff;" data-toggle='modal' data-target='#viewleadremarkhistorymodal' data-backdrop='static' data-keyboard='false' data-project_id="">Lead Communications</a>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                          </div>
