    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url().'dashboard/';?>l" class="site_title"><div class="image"> <span>Better Bound House</div></a>
            </div>
                ...
                <li><a><i class="fa fa-list"></i> Current Transactions Guide <span class="fa fa-chevron-down"></span></a>
                 ...
                 <li><a><i class="fa fa-calendar"></i> Calendar of Activities <span class="fa fa-chevron-down"></span></a>
                     ...
                     <ul class="nav child_menu"> 
                      ...
                      <li><a href="<?php echo site_url("dashboard/email_user_history")?>">Masterlist Calendar</a></li>
                        <?php endif; ?>
        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
  <div class="card" style="width:50%; margin: 0 auto; float: none; margin-bottom: 10px;">
          <div class="card-body">
        
            <h5 style="text-align: center;">Book Price Estimation Calculator</h5>
            ...
            <form name="costcalculator">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="months" id="months">
                  ...
                  <option value="2">Amazon.de</option>
                  <option value="2">Amazon.fr</option>
                  <option value="2">Amazon.it</option>
                  <option value="2">Amazon.es</option>
                  <option value="2">Amazon.ca</option>
                </select>
              </div>

              <div class="form-group">
                <label>Anticipated list price</label>
                <input type="number" class="form-control" name="price">
              </div>              

              <button type="button" class="btn btn-info" onclick="calculatePrice()">Calculate</button>
              <div id="price"></div> 
            </form>
...
function calculatePrice()
{
  ...
  var price = interior * pages;
  document.getElementById('price').innerHTML = 'Printing cost: '+price;
}
</script>
  </body>
</html>
