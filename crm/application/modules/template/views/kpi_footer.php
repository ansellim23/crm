...
<script type="text/javascript">
 var pageURL = $(location).attr("href");
  ...
  if (pageURL == 'https://hlmcrm.site/dashboard/schedule_attendance'){
    ...
    <script src="<?php echo base_url('js/croppie.js');?>"></script>
     ...
     <script src="<?php echo base_url('js/validateaddcriterion.js');?>"></script>
     <script src="<?php echo base_url('js/validateevaluation.js');?>"></script>
     <script src="<?php echo base_url('js/validatekpi.js');?>"></script>
 ...
 $('#evaluationdataTable').DataTable();
 $('#kpidataTable').DataTable();
