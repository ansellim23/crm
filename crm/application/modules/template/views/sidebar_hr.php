              ...
              <ul class="nav side-menu">   
                ...
                <li><a><i class="fa fa-users"></i> Human Resource Department <span class="fa fa-chevron-down"></span></a>
                   <ul class="nav child_menu">
                     ...
                     <!-- <li><a href="<?php echo site_url("dashboard/SubmittedFormsHr")?>">Submitted Forms</a></li> -->
                   </ul>
                </li>
                <li><a><i class="fa fa fa-wpforms"></i>Forms<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu"> 
                        <li><a href="<?php echo site_url("dashboard/leaveFormHr")?>">Leave Request Form</a></li>
                        <li><a href="<?php echo site_url("dashboard/officialBusinessLeaveFormHr")?>">OBL Request Form</a></li>
                        <li><a href="<?php echo site_url("dashboard/undertimeFormHr")?>">Undertime Request Form</a></li>
                      </ul>
                </li>
