...
// Addd Time
$(document).on('click','#addtimelineform #add_timeline',function(e) {
  $.ajax({
         type: "POST",
         url: base_url +  "dashboard/insert_time_line",
         dataType: 'json',
         data: $("#addtimelineform").serialize(),
         success: function(res) {
        if (res.response=="success"){
            $("#addtimelineform .alert-danger").removeClass("alert-danger").addClass("alert-success");
            $("#addtimelineform .alert-success").css("display", "block");
            $("#addtimelineform .alert-success p").html(res.message);
             location.reload();


        }
         else{
            $("#addtimelineform .alert-success").removeClass("alert-success").addClass("alert-danger");
            $("#addtimelineform .alert-danger").css("display", "block");
            $("#addtimelineform .alert-danger p").html(res.message);
            setTimeout(function(){
                    $("#addtimelineform .alert-danger").css("display", "none");
                },3000);
...
$(document).on('click','#addcompanyform #add_company_event',function(e) {
  $.ajax({
         type: "POST",
         url: base_url +  "dashboard/insert_company_calendar",
         dataType: 'json',
         data: $("#addcompanyform").serialize(),
         success: function(res) {
        if (res.response=="success"){
            $("#addcompanyform .alert-danger").removeClass("alert-danger").addClass("alert-success");
            $("#addcompanyform .alert-success").css("display", "block");
            $("#addcompanyform .alert-success p").html(res.message);
                   setTimeout(function(){
                      location.reload();
                },2000);
            ...
            $("#addcompanyform .alert-success").removeClass("alert-success").addClass("alert-danger");
            $("#addcompanyform .alert-danger").css("display", "block");
            $("#addcompanyform .alert-danger p").html(res.message);
            setTimeout(function(){
                    $("#addcompanyform .alert-danger").css("display", "none");
                },3000);
...
$(document).on('click','#addpersonalform #add_personal_event',function(e) {
  $.ajax({
         type: "POST",
         url: base_url +  "dashboard/insert_personal_calendar",
         dataType: 'json',
         data: $("#addpersonalform").serialize(),
         success: function(res) {
        if (res.response=="success"){
            $("#addpersonalform .alert-danger").removeClass("alert-danger").addClass("alert-success");
            $("#addpersonalform .alert-success").css("display", "block");
            $("#addpersonalform .alert-success p").html(res.message);
                   setTimeout(function(){
                      location.reload();
                },2000);
            ...
            $("#addpersonalform .alert-success").removeClass("alert-success").addClass("alert-danger");
            $("#addpersonalform .alert-danger").css("display", "block");
            $("#addpersonalform .alert-danger p").html(res.message);
            setTimeout(function(){
                    $("#addpersonalform .alert-danger").css("display", "none");
                },3000);
